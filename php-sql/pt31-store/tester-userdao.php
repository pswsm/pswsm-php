...
print_r($dao->insert(new User(0, "peter01", "ppass01", "peter", "frampton", "registered")));
echo '<br>';
print_r($dao->update(new User(7, "peter11", "ppass11", "peter1", "frampton1", "admin")));
echo '<br>';
print_r($dao->delete(new User(7)));
